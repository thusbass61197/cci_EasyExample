...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_3), TYPEID_MACRO, WORD(16),
		...
		CMD_CONTROL_AUDIO_DEVICE, 2, WORD(100), WORD(100), WORD(200)
	ID(Macro_4), TYPEID_MACRO, WORD(16),
		CMD_HIDE_SHOW, ID(Container_Gesamtzaehler), 1, 0xFF, 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 3, WORD(550), WORD(100), WORD(200)
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 9, 0, 
		...
		XYREF(Container_Tageszaehler, 204, 7),
		XYREF(OutputString_ZielErreicht, 500, 150),
		XYREF(Button_S2, 303, 155),
		XYREF(S1, 396, 79),
		XYREF(Button_hin, 215, 223),
		XYREF(Button_weg, 218, 157),
	ID(DataMask_s2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_S3, 88, 191),
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(91), WORD(56), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputSring_S2, -4, 14),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(S1), TYPEID_BUTTON, WORD(80), WORD(80), 187, 144, 1, 0, 1, 0, 
		XYREF(Icon_Button_MinusMinus, 0, 0),
	ID(Button_S3), TYPEID_BUTTON, WORD(87), WORD(51), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S3, -4, 12),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(Button_weg), TYPEID_BUTTON, WORD(75), WORD(52), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11008, -4, 10),
		MACRO(EV_KEYRELEASE, Macro_3),
	ID(Button_hin), TYPEID_BUTTON, WORD(78), WORD(47), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_hin, -4, 10),
	...
	ID(OutputSring_S2), TYPEID_OUTSTR, WORD(91), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_S3), TYPEID_OUTSTR, WORD(87), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '3', ' ', ' ', 0,
	ID(OutputString_hin), TYPEID_OUTSTR, WORD(78), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'h', 'i', 'n', ' ', 0,
	ID(OutputString_11008), TYPEID_OUTSTR, WORD(71), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'w', 'e', 'g', ' ', 0,
