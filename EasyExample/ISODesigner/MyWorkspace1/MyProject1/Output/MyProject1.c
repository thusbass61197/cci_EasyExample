...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Container_Gesamtzaehler), TYPEID_CONTAINER, WORD(191), WORD(470), 0, 8, 0, 
		...
		XYREF(ObjectPointer_27003, 5, 150),
	ID(Container_Tageszaehler), TYPEID_CONTAINER, WORD(191), WORD(470), 0, 8, 0, 
		...
		XYREF(ObjectPointer_27001, 5, 150),
	...
	ID(SoftKey_PlusPlus), TYPEID_SOFTKEY, COLOR(187), 1, 1, 0, 
		XYREF(OutputString_SoftKey_PlusPlus, 0, 0),
	...
	ID(SoftKey_MinusMinus), TYPEID_SOFTKEY, COLOR(187), 1, 1, 0, 
		XYREF(OutputString_SoftKey_MinusMinus, 0, 0),
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(80), WORD(80), 187, 144, 1, 0, 1, 0, 
		XYREF(OutputString_PlusPlus, 0, 0),
	...
	ID(Button_MinusMinus), TYPEID_BUTTON, WORD(80), WORD(80), 187, 144, 1, 0, 1, 0, 
		XYREF(OutputString_MinusMinus, 0, 0),
	...
	ID(InputNumber_Tagesziel), TYPEID_INNUM, WORD(120), WORD(55), COLOR_WHITE, ID(FontAttributes_Default), 0, 
		ID(ID_NULL), LONG(123UL), LONG(0UL), LONG(65535UL), LONG(0L), FLOAT_1, 0, 0, 2, 1, 0, 
	ID(OutputString_SoftKey_PlusPlus), TYPEID_OUTSTR, WORD(72), WORD(72), COLOR_WHITE, ID(FontAttributes_SoftKey), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_SoftKey_MinusMinus), TYPEID_OUTSTR, WORD(72), WORD(72), COLOR_WHITE, ID(FontAttributes_SoftKey), 1,
		ID(ID_NULL), 5, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_PlusPlus), TYPEID_OUTSTR, WORD(72), WORD(72), COLOR_WHITE, ID(FontAttributes_Button), 1,
		ID(ID_NULL), 5, WORD(4), '+', '+', ' ', ' ', 0,
	...
	ID(FontAttributes_SoftKey), TYPEID_FONTATTR, COLOR_BLACK, 5, 0, 129, 0, 
	ID(FontAttributes_Default), TYPEID_FONTATTR, COLOR_BLACK, 3, 0, 129, 0, 
	ID(FontAttributes_Button), TYPEID_FONTATTR, COLOR_BLACK, 5, 0, 128, 0, 
	...
	ID(AuxFunction2_PlusPlus), TYPEID_AUXFUNC2, COLOR_WHITE, 130, 1, 
		XYREF(OutputString_SoftKey_PlusPlus, -22, 0),
